  ...
  var mxData;
  $.ajax({
    url: "partials/Catálogo Centros de Trabajo.json",
    async: false,
  ...
  function mapaMX(){
    map = L.map('mapMX').setView([24, -95], 10);
    ...
    function getColor(d) {
        return d > 20000 ? '#008261' : d > 10000 ? '#049873' : d > 5000 ? '#00af83' : '#17f5bd';
    }
