...
function getInfoChart(var1) {
    ...
    switch (grafica) {
        ...
        case (grafica.match(/Inmigrantes.*/)|| {}).input:
            ...
            datos=["Proyecciones de la población de México", "CONAPO", "JSON", "https://datos.gob.mx/busca/dataset/proyecciones-de-la-poblacion-de-mexico", "http://www.conapo.gob.mx/work/models/CONAPO/Proyecciones/Datos/Bases_de_Datos/Indicadores_demograficos/Descriptor/Diccionario_Emigrantes_Interestatales.csv"]
        break;
        case (grafica.match(/Defunciones.*/)|| {}).input:
            ...
            datos=["Proyecciones de la población de México", "CONAPO", "JSON", "https://datos.gob.mx/busca/dataset/proyecciones-de-la-poblacion-de-mexico", "http://www.conapo.gob.mx/work/models/CONAPO/Proyecciones/Datos/Bases_de_Datos/Indicadores_demograficos/Descriptor/Diccionario_Defunciones.csv"]
        break;
        case (grafica.match(/Por localidad.*/)|| {}).input:
            ...
            datos=["Proyecciones de la población de México", "CONAPO", "JSON", "https://datos.gob.mx/busca/dataset/proyecciones-de-la-poblacion-de-mexico", "http://www.conapo.gob.mx/work/models/CONAPO/Proyecciones/Datos/Bases_de_Datos/Proyecciones_Localidades/Descriptor/Diccionario_Proyecciones_por_Localidad.csv"]
        break;
        case (grafica.match(/Municipios 2010.*/)|| {}).input:
            ...
            datos=["Proyecciones de la población de México", "CONAPO", "JSON", "https://datos.gob.mx/busca/dataset/proyecciones-de-la-poblacion-de-mexico", "http://www.conapo.gob.mx/work/models/CONAPO/Proyecciones/Datos/Bases_de_Datos/Proyecciones_Municipios/Descriptor/Diccionario_Proyecciones_por_Municipios.csv"]
        break;
