...
function getInfoChart(var1) {
    ...
    switch (grafica) {
        ...
        case (grafica.match(/rezago.*/)|| {}).input:
            ...
            datos=["Índice de Rezago Social,2000-2010 (nacional,estatal,municipal, localidad y ageb)", "CONEVAL", "CSV", "http://google.com"];
        break;
        ...
        case (grafica.match(/Municipios 2010.*/)|| {}).input:
            ...
            datos=["Proyecciones de la población de México", "CONAPO", "JSON"]
        break;
        case (grafica.match(/Catálogo Centros de Trabajo.*/)|| {}).input:
